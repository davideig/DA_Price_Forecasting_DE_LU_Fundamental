...
def run_point_base_forecasts(
    ...
    forecast_df, runtime_df, _, _, _ = rolling_point_forecast(
        ...
        price_model_type=lear_config.price_model_type,
        hgb_max_iter=lear_config.hgb_max_iter,
        hgb_learning_rate=lear_config.hgb_learning_rate,
        hgb_max_leaf_nodes=lear_config.hgb_max_leaf_nodes,
        hgb_min_samples_leaf=lear_config.hgb_min_samples_leaf,
        hgb_l2_regularization=lear_config.hgb_l2_regularization,
        lgbm_n_estimators=lear_config.lgbm_n_estimators,
        lgbm_learning_rate=lear_config.lgbm_learning_rate,
        lgbm_num_leaves=lear_config.lgbm_num_leaves,
        lgbm_min_child_samples=lear_config.lgbm_min_child_samples,
        lgbm_subsample=lear_config.lgbm_subsample,
        lgbm_colsample_bytree=lear_config.lgbm_colsample_bytree,
        lgbm_reg_lambda=lear_config.lgbm_reg_lambda,
        random_state=lear_config.random_state,
    )
