...
### Feature Pack For Reuse

Historical weather and API-derived feature caches are not committed to Git. To
make the final models reusable, distribute a versioned data pack next to a GitHub
Release, Zenodo record, OSF upload, or institutional storage object.
